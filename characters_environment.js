...
var gameConfig={
  ...
  moveSpeed: 1000000,
  enemyMoveSpeed: 0.0000000000000001,
...
function startgam() {
  gamestatus="start"
  document.getElementById("status").innerHTML="game is load yes very pro"
}
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("ply plez i giv no bt yes E", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
    stroke(255);
    strokeWeight(7);
    noFill();
